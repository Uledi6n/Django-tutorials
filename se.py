...
# Round Image
#img = Image.open("logo.jpg")  # Replace with your image path
#img = ImageOps.fit(img, (150, 150), method=0, bleed=0.0)  # Resize and crop to a square
...
#img = ImageOps.fit(img, (150, 150), method=0, bleed=0.0)
#img.putalpha(mask)
